...
# admin customization
ADMIN_SITE_HEADER = "ConnectHub Admin Panel - Developed by Rachit Kumar Singh"
ADMIN_SITE_TITLE = "ConnectHub Admin"
ADMIN_INDEX_TITLE = "Welcome to ConnectHub Admin Dashboard"
